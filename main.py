...
# pred.to_excel(f"results_{product}.xlsx")
# plt.figure()
# ticks = pred["ds"].apply(to_jalali)

# plt.plot(ticks, pred["yhat"],label="predictions")
# plt.fill_between(x=ticks, y1=pred["yhat_upper"], y2=pred["yhat_lower"],alpha=0.3)
# plt.savefig(f"figures/{product}_predictions.jpg")
# pred["ds"] = pred["ds"].apply(to_jalali)
